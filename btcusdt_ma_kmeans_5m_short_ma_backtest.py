...
# --- Configuration for 5-Minute Timeframe with Shorter MAs ---
API_KEY = None
API_SECRET = None
SYMBOL = "BTCUSDT"
...
END_DATE = "1 Apr, 2024"
N_CLUSTERS = 5
# Shorter MAs for 5m timeframe (equivalent to 20/100 on 1H)
MA_FAST = 240
MA_SLOW = 1200
...
def run_backtest_and_plot(df, roles):
    print("\n--- Running Backtest (5-Minute, Short MAs, Long-Only) ---")
    ...
    plt.title('5-Minute K-Means Backtest (Shorter MAs)')
    plt.show()
...
def main():
    ...
    print("\n--- 5-Minute Backtest Results (Shorter MAs) ---")
