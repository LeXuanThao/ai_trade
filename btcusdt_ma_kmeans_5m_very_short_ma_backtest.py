...
# --- Configuration for 5-Minute Timeframe with Very Short MAs ---
API_KEY = None
API_SECRET = None
SYMBOL = "BTCUSDT"
...
END_DATE = "1 Apr, 2024"
N_CLUSTERS = 5
# Very Short MAs for 5m timeframe (equivalent to 10/50 on 1H)
MA_FAST = 120
MA_SLOW = 600
...
def run_backtest_and_plot(df, roles):
    print("\n--- Running Backtest (5-Minute, Very Short MAs, Long-Only) ---")
    ...
    plt.title('5-Minute K-Means Backtest (Very Short MAs)')
    plt.show()
...
def main():
    ...
    print("\n--- 5-Minute Backtest Results (Very Short MAs) ---")
